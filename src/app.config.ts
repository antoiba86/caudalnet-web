...
export const appConfig: ApplicationConfig = {
    providers: [
        // Hash routing keeps deep links working behind a reverse proxy that mounts the
        // app under a dynamic prefix: the fragment never reaches the server, so no
        // rewrite rules are needed and a refresh on /#/portfolios still resolves.
